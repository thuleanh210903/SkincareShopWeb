        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        @foreach($edit_category_post as $edit_value)
                        <form class="row" method="post" action="{{URL::to('/update-category-post/'.$edit_value->id_cate_post)}}">
                            {{ csrf_field() }}
                            <div class="form-group col-md-4">
                                <label class="control-label">Tên danh mục</label>
                                <input class="form-control" type="text" name="cate_post_name" value="{{ $edit_value->cate_post_name}}">
                            </div>

                            <div class="form-group col-md-4">
                                <label class="control-label">Mô tả</label>
                                <textarea class="form-control" rows="4" name="cate_post_desc"  value="{{ $edit_value->cate_post_desc}}"></textarea>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleSelect1" class="control-label">Tình trạng</label>
                                <select class="form-control" id="exampleSelect1" name="cate_post_status"  value="{{ $edit_value->cate_post_status}}">
                    ...
                    <button class="btn btn-save" type="submit" name="update_category_post">Cập nhật</button>
