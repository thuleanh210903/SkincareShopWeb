          ...
          <div class="tile-body">
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="{{URL::to('/add-post')}}" title="Thêm"><i class="fas fa-plus"></i>
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="public/admin/image/post/{{ $post->post_image }}" height="50" width="50"></td>
                  <td>
                  <?php
                  echo $post -> post_sum  
                  ?>  
                 ...
                 <td>
                  ...
                  <td><a class="btn btn-primary btn-sm trash" type="button" title="Xóa"  href="{{URL::to('/delete-post/'.$post->id_post)}}" onclick="return confirm('Bạn có chắc muốn xóa danh mục này không?')"><i class="fas fa-trash-alt"></i>
                    </a>
                    <a class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" href="{{URL::to('/edit-post/'.$post->id_post)}}"><i class="fas fa-edit"></i></a>
