      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" method="POST" action="{{URL::to('/save-post')}}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="form-group col-md-3">
                <label class="control-label">Mã bài viết</label>
                <input class="form-control" type="number" placeholder="" name="id_post">
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3 ">
                ...
                <select class="form-control" id="exampleSelect1" name="post_status">
              ...
              <div class="form-group col-md-3">
                ...
                <label for="exampleSelect1" class="control-label">Bài viết</label>

                <select class="form-control" id="exampleSelect1" name="id_cate_post">
                  @foreach($cate_po as $cate)
                  <option value="{{ $cate->id_cate_post}}">{{ $cate->cate_post_name}}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="form-group col-md-12">
                ...
                <div id="myfileupload">
                  <input type="file" id="uploadfile" onchange="readURL(this);" name="post_image" />
                </div>
                <div id="thumbbox">
              ...
              <div class="form-group col-md-12">
                ...
                <textarea class="ckeditor" name="post_sum" id="mota"></textarea>
                <script>
              ...
              <div class="form-group col-md-12">
                ...
                <textarea class="ckeditor" name="content" id="mota"></textarea>
                <script>
                  CKEDITOR.replace('mota');
                </script>
              </div>
              <div class="form-group col-md-12">
                <label class="control-label">Đoạn</label>
                <textarea class="ckeditor" name="post_meta_desc" id="mota"></textarea>
                <script>
                  CKEDITOR.replace('mota');
                </script>
