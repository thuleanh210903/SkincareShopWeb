      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" method="POST" action="{{URL::to('/save-product')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="form-group col-md-3">
                <label class="control-label">Mã sản phẩm </label>
                <input class="form-control" type="number" placeholder="" name="id_product">
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3 ">
                ...
                <select class="form-control" id="exampleSelect1" name="show_product">
              ...
              <div class="form-group col-md-3">
                ...
                <select class="form-control" id="exampleSelect1" name="id_category_product" >
                @foreach($cate_pro as $cate)
                  ...
                  <!-- <option>Sửa rữa mặt</option>
                  <option>Tẩy trang</option>
                  <option>Mặt nạ</option>
                  <option>Kem dưỡng ẩm</option>
                  <option>Sản phẩm đặc trị</option> -->
              ...
              <div class="form-group col-md-12">
                ...
                <textarea class="form-control" name="describe_product" id="mota"></textarea>
