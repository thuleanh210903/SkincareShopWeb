      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" method="post" action="{{URL::to('/update-category-product/'.$edit_value->id_category_product)}}">
              {{ csrf_field() }}
              <div class="form-group col-md-4">
                <label class="control-label">Tên danh mục</label>
                <input class="form-control" type="text" name="name_category_product" value="{{ $edit_value->name_category_product}}">
              </div>
