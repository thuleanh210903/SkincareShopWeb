      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" method="POST" action="{{URL::to('/save-coupon')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="form-group col-md-3">
                <label class="control-label">Mã sản phẩm </label>
                <input class="form-control" type="number" placeholder="" name="id_coupon">
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group  col-md-3">
                ...
                <input class="form-control" type="number" name="coupon_time">
              </div>
              <div class="form-group  col-md-3">
              ...
              <div class="form-group col-md-3 ">
                <label for="exampleSelect1" class="control-label">Tính năng</label>
                <select class="form-control" id="exampleSelect1" name="coupon_condition">
              ...
              <div class="form-group col-md-3">
                <label class="control-label">Nhập số % hoặc tiền giảm</label>
          ...
          <button class="btn btn-save" type="submit" name="add_coupon">Lưu lại</button>
