    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
          @foreach($edit_order as $edit_value)
            <form class="row" method="post" action="{{URL::to('/update-order-status/'.$edit_value->id_order)}}" enctype="multipart/form-data">

              @csrf

              <input type="text" hidden name="id_order" value="{{ $edit_value->id_order }}" readonly="readonly">
              <div class="form-group col-md-4">
                <label class="control-label">Tổng tiền</label>
                <input class="form-control" type="text" name="order_total" value="{{ $edit_value->order_total.' 000 VND' }}" readonly="readonly">
              </div>
              <div class="form-group col-md-4">
                <label class="control-label">Ngày đặt hàng</label>
                <input class="form-control" type="text" name="order_date" value="{{ $edit_value->order_date}}" readonly="readonly">
              </div>
             
              <div class="form-group col-md-4">
                <label for="exampleSelect1" class="control-label">Tình trạng</label>
                <select class="form-control" id="exampleSelect1" name="order_status" value="{{$edit_value->order_status}}">
